        ...
        <div class="card-header">
            <div class="row flex-between-center">
                <div class="col-4 col-sm-auto d-flex align-items-center pe-0">
                    <h5 class="fs-9 mb-0 text-nowrap py-2 py-xl-0">Product Update</h5>
                </div>
            </div>
        </div>
        <div class="card-body">
            <form class="row" id="productForm">
                ...
                <div class="col-4 mb-3">
                  ...
                  <input class="form-control" id="base_price" type="text" name="base_price" value="{{ $product->base_price }}" />
                </div>
                <div class="col-4 mb-3">
                    <label class="form-label" for="discount_percentage">Discount in percentage:</label>
                    <input class="form-control" id="discount_percentage" type="number" min="0" max="100" name="discount_percentage" value="{{ $product->discount_percentage }}" />
                </div>
                <div class="col-4 mb-3">
                    <label class="form-label" for="discounted_price">Discounted Price:</label>
                    <input class="form-control" id="discounted_price" type="text" name="discounted_price" value="{{ $product->discounted_price }}" />
                </div>
                <div class="col-4 mb-3">
                    ...
                    <input class="form-control" id="final_price" type="text" name="final_price" value="{{ $product->final_price }}" readonly />
                </div>
                <div class="col-4 mb-3">
                    ...
                    <div class="row" id="imagePreview">
                        @foreach ($product->images as $image)
                            <div class="col-2 mb-2">
                                <img src="{{ asset('images/products/thumb/' . $image->image) }}" alt="Product Image"
                                    class="img-fluid img-thumbnail border" />
                            </div>
                        @endforeach
                    </div>
                </div>
                ...
                <div class="col-6 mb-3">
                    ...
                    <input class="form-control" id="stock" type="text" name="stock" value="{{ $product->stock }}" />
                </div>
                <div class="col-6 mb-3">
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#productForm').on('submit', function (e) {
                ...
                ajaxCall('{{ route('vendor.products.update', $product->id) }}', 'POST', formData, function (response) {
