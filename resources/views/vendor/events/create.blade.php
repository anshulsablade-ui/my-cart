        ...
        <div class="card-header">
            <div class="row flex-between-center">
                <div class="col-4 col-sm-auto d-flex align-items-center pe-0">
                    <h5 class="fs-9 mb-0 text-nowrap py-2 py-xl-0">Event Create</h5>
                </div>
            </div>
        </div>
        <div class="card-body">
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#eventForm').on('submit', function (e) {
                ...
                ajaxCall("{{ route('vendor.events.store') }}", 'POST', formData, function (response) {
                    if (response.status === 'success') {
                        window.location.href = '{{ route('vendor.events.index') }}';
                    }
                }, function (res) {
