                      ...
                      <div class="position-relative">
                        <div class="position-absolute top-0 end-0 z-1 pt-1 pe-1 mt-2 me-2">
                          <div class="form-check fs-lg">
                            ...
                            <a class="nav-link animate-underline px-0 py-2" href="javascript:void(0)" wire:click="removeWishlist({{ $item->id }})" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-custom-class="tooltip-sm" data-bs-title="Remove Wishlist" aria-label="Remove Wishlist">
