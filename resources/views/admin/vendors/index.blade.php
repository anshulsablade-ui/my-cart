...
@section('content')
  ...
  <div class="card mb-3">
    <div class="card-header">
      <div class="row flex-between-center">
        <div class="col-4 col-sm-auto d-flex align-items-center pe-0">
          <h5 class="fs-9 mb-0 text-nowrap py-2 py-xl-0">Vendor List</h5>
        </div>
        <div class="col-8 col-sm-auto ms-auto text-end ps-0">
          <div>
            <button class="btn btn-falcon-default btn-sm" type="button" onclick="window.location='{{ route('admin.vendors.create') }}'">
    ...
    <div class="card-body px-0">
      <!-- data table -->
      <table class="table mb-0 data-table fs-10" id="vendorsTable">
        <thead class="bg-200">
          <tr>
            <th class="text-900 text-nowrap py-1">Name</th>
            <th class="text-900 text-nowrap py-1">Email</th>
            <th class="text-900 text-nowrap py-1">Product</th>
...
<script>
    $(document).ready(function() {
        ...
        // Vendor DataTable
        window.table = $('#vendorsTable').DataTable({
            processing: true,
            serverSide: true,
